...
//  hard coded data base has now been commented out. replaced with a MongoDB database 
//  const aliens = {
//     'humans':{
//         'speciesName' : 'Humans',
//         'homeworld': 'Earth',
...
MongoClient.connect(connectionString)
    .then(client => {
        ...
        const db = client.db('got-star-trek-api')
...
app.listen(process.env.PORT || PORT, ()=>{
    console.log(`Welcome to Star Trek planet ${PORT}`)
})